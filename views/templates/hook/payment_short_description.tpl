...
<p class="payment_module">
    <a id="top3_payment" href="#" onclick="submitForm();">
        <span class="top3_payment_img"><img src="{$logo3cb|escape:'htmlall':'UTF-8'}" /></span>
        <span class="top3_payment_text"><br/>{l s='Pay by CB in 2X, 3X or 4X without fees' mod='top3'}</span>
    </a>
</p>
