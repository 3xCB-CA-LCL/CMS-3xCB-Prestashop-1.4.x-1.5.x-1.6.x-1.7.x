 ...
 *
 */
class Top3Customer extends Top3XMLElement {
  ...
  /**
   * creates an object Top3XMLElement reprensenting <siteconso>, adds it to the current object and sets its children, then returns it
   * 
