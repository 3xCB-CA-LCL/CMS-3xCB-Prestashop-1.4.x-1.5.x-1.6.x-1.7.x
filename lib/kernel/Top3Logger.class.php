...
class Top3Logger
{
	...
	{
		if (!file_exists(TOP3_ROOT_DIR.'/logs/'))
			if (!mkdir(TOP3_ROOT_DIR.'/logs/'))
				die('Error creating logs folder');

		$log_filename = TOP3_ROOT_DIR.'/logs/fianet_log.txt';
		...
		{
			$prefix = TOP3_ROOT_DIR.'/logs/fianetlog-';
			$base = date('YmdHis');
			$sufix = '.txt';
	 ...
	 */
	public static function insertLogTop3($from, $msg)
	{
