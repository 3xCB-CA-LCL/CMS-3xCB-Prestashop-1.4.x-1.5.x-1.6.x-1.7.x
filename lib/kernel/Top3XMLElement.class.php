...
class Top3XMLElement extends DOMElement
{
	...
	/**
	 * creates an Top3XMLElement then adds as a child then returns the child
	 * 
	 * @param string $name
	 * @param string $value
	...
	{
		$child = $this->appendChild(new Top3XMLElement($name));
		if ($cdata && constant('TOP3_USE_CDATA') !== false)
